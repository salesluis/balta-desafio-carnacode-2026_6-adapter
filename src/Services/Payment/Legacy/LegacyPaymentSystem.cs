...
namespace DesignPatternChallenge.Services.Payment.Legacy;

public class LegacyPaymentSystem
{
    public LegacyTransactionResponse AuthorizeTransaction(LegacyTransactionRequest request)
    {
        Console.WriteLine($"[Sistema Legado] Autorizando transação...");
        Console.WriteLine($"Cartão: {request.cardNum}");
        Console.WriteLine($"Valor: {request.amountInCents / 100:C}");
